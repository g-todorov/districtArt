...
HeaderCtrl.$inject = ['$scope', '$rootScope', '$window', 'AuthService', '$state', '$location', '$modal', 'Notifications', 'socket', '_'];

function HeaderCtrl($scope, $rootScope, $window, AuthService, $state, $location, $modal, Notifications, socket, _) {
  $scope.notifications = [];
