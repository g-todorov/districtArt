'use strict';
 
angular.module('users').controller('personalPageController', ['$scope', '$http', 'usersService', 'AuthService', 'API_ENDPOINT', function ($scope, $http, usersService, AuthService, API_ENDPOINT) {
